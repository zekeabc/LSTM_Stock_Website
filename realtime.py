...
def _format_stock_info(data) -> dict:
    ...
    result['realtime']['closed_yesterday'] = data.get('y', None)
    result['realtime']['price_difference'] = eval("({}-{})".format(data.get('z', None), data.get('y', None)))
    result['realtime']['price_difference_spread'] = eval("({}-{})/{}*100".format(data.get('z', None), data.get('y', None), data.get('y', None)))
